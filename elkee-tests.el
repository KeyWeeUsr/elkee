...
(ert-deftest elkee-kdbx4-unprotect-xml ()
  (with-dummy-db 'kdbx4
    (should (string= "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?>
<KeePassFile>
        <Meta>
...
" (elkee-database-xml-unsafe (elkee-read-buffer "dummy" nil t))))))
